...
//this part is for fetching the AutoGenerated ID from the database
  ...
  createFabricEntry(f: FabricCalulation){
   const addChest = this.chestinput.concat('-'+this.chestselect);
   f.chest = addChest;
   console.log(addChest);
   const addlength = this.lengthinput.concat('-'+this.lengthselect);
   f.length = addlength;
