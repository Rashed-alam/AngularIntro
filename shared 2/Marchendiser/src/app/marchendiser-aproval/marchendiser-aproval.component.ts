...
@Component({
  selector: 'app-marchendiser-aproval',
  templateUrl: './marchendiser-aproval.component.html',
  styleUrls: ['./marchendiser-aproval.component.css']
})
export class MarchendiserAprovalComponent implements OnInit {
  ...
  updatePricecalc(m) {
    ...
    // console.log(m);
    this.Fc.createMarchendiserArchive(this.b_old).subscribe(res => {
    if (this.reviewReport.perUnitPrice === parseFloat(m.fabricPriceInformation[0].perUnitPrice)) {
      ...
      // console.log(this.reviewReport.perUnitPrice );
      // console.log(parseFloat( m.fabricPriceInformation[0].perUnitPrice));
      // console.log("equal");
   //   m.fabricPriceInformation[0].Mremarks = 'equal/no change made';
      this.Fc.updateEntry(m).subscribe((res) => {
        this.getreportdata(this.reviewReport.referenceId);
        console.log("equal");
      }
    ...
    //  m.fabricPriceInformation[0].Dremarks = '';
      ...
      if (this.reviewReport.perUnitPrice < parseFloat(m.fabricPriceInformation[0].perUnitPrice)) {
    //    m.fabricPriceInformation[0].Mremarks = 'price increased';
        this.Fc.updateEntry(m).subscribe((res) => {
          this.getreportdata(this.reviewReport.referenceId);
          console.log("beshi");
        }
        ...
        m.fabricPriceInformation[0].Mremarks = 'price decreased';
        this.Fc.updateEntry(m).subscribe((res) => {
